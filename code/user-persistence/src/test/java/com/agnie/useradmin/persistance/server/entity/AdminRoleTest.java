...
public class AdminRoleTest extends BaseUserAdminTest {
	...
	public void clean() throws Exception {
		try {
			em.get().createQuery("DELETE FROM AdminRole", AdminRole.class).executeUpdate();
	...
	public void create() {
		...
		try {
			EntityManager em = getEntityManager();
			AdminRole ar = em.find(AdminRole.class, id);
