...
public class UserApplicationRegistrationTest extends BaseUserAdminTest {
	...
	public void clean() throws Exception {
		try {
			em.get().createQuery("DELETE FROM UserApplicationRegistration", UserApplicationRegistration.class).executeUpdate();
	...
	public void create() {
		...
		try {
			EntityManager em = getEntityManager();
			UserApplicationRegistration apr = em.find(UserApplicationRegistration.class, id);
